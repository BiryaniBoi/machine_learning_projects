...
class TestActedTogether(unittest.TestCase):
    ...
    def test_01(self):
        ...
        actor1 = 4724
        actor2 = 9210
        self.assertTrue(bacon.did_x_and_y_act_together(self.data, actor1, actor2))

    def test_02(self):
        # Simple test, two actors who had not acted together
        actor1 = 4724
        actor2 = 16935
        self.assertFalse(bacon.did_x_and_y_act_together(self.data, actor1, actor2))
...
class TestBaconNumber(unittest.TestCase):
    ...
    def test_04(self):
        ...
        result = bacon.get_actors_with_bacon_number(self.data, n)
...
class TestActorPath(unittest.TestCase):
    ...
    def test_06(self):
        ...
        actor_2 = 89614
        len_expected = 7
        result = bacon.get_path(self.db_large, actor_1, actor_2)
...
class TestBaconPath(unittest.TestCase):
    ...
    def test_10(self):
        ...
        actor_id = 2876669
        expected = None
        result = bacon.get_bacon_path(self.db_small, actor_id)
        self.assertEqual(result, expected)
    ...
    def test_12(self):
        ...
        actor_id = 1204
        len_expected = 2
        result = bacon.get_bacon_path(self.db_large, actor_id)
        len_result = -1 if result is None else len(result)-1
        self.assertTrue(valid_path(self.db_large, result))
        self.assertEqual(len_result, len_expected)
        self.assertEqual(result[0], 4724)
